...
```
      ...
      ▼             ▼             ▼             ▼             ▼             ▼             ▼             ▼
 ┌────────────┐  ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌─────────────┐ ┌─────────────┐
 │    Data    │  │ Transparency│ │     Huma    │ │ Accuracy &  │ │ Conformity  │ │  Technical  │ │ Post-Market │
 │ Governance │  │    & Info   │ │  Oversight  │ │ Robustness  │ │ Assessment  │ │Documentation│ │ Monitoring  │
